### u6lesson03-gpimage02.gp
### Same curve f(x) = -0.2(x-5)^2 + 6, showing the tangent at P plus two
### secants PQ (far) and PR (near) -- PR's slope is much closer to the
### tangent's slope than PQ's is.

set terminal pngcairo size 320,240 font ",8"
set output '../u6lessons-media/u6lesson03-gpimage02.png'
...
set label "secant" at 4.6,4.5 tc rgb 'blue' font ",7"
set label "Tangent" at 0.3,1.0 tc rgb 'red' font ",7"
