3.4 Résolution des équations exponentielles -- Leçon
################################################################################
...
:summary: 3.4 Résolution des équations exponentielles -- Leçon
...
facile de résoudre en prenant le ``_____`` des deux côtés et en
appliquant la ``_____`` des logarithmes pour retirer la variable de
l'``_____``.
