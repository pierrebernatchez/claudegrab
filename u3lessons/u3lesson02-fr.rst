3.2 Loi de la puissance des logarithmes -- Leçon
################################################################################
...
:summary: 3.2 Loi de la puissance des logarithmes -- Leçon
...
comme :math:`\log_{1.05} 2`, tu peux utiliser la ``_____`` :
...
Utilisant cette formule, nous pourrions déterminer que
:math:`\log_{1.05} 2 =` ``_____``, ce qui est exactement ce que nous
avons obtenu en utilisant la loi de la puissance des logarithmes.
