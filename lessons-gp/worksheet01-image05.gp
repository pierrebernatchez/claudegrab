### worksheet01-image05.gp
### Q3 table, row 5: odd-degree, negative leading coefficient (decreasing line).

set terminal pngcairo size 190,150 enhanced font "Arial,8"
set output '../lessons-media/worksheet01-image05.png'
...
plot -x with lines lw 2 lc rgb "#c0392b"
