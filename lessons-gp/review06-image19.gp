### review06-image19.gp
### Q15 (symmetry) row c: schematic function with point symmetry about a
### point other than the origin. No exact equation given in the source.

set terminal pngcairo size 160,160 enhanced font "Arial,9"
set output '../lessons-media/review06-image19.png'
...
plot 0.4*(x-0.6)**3 + 0.3 with lines lw 2 lc rgb "#3366cc"
