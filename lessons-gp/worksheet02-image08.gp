### worksheet02-image08.gp
### Table 2 row 3: f(x) = x^3 - 3x
### degree 3, positive leading coeff, 3 x-intercepts, 2 turning points,
### Q3 to Q1, point symmetry about the origin.

set terminal pngcairo size 220,190 enhanced font "Arial,9"
set output '../lessons-media/worksheet02-image08.png'
