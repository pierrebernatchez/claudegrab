...
### coefficient: 4 turning points, 5 x-intercepts, Q2 to Q4.

set terminal pngcairo size 170,150 enhanced font "Arial,9"
set output '../lessons-media/lesson02-image20.png'
...
plot -(0.15*(x**5 - 5*x**3 + 4*x)) with lines lw 2 lc rgb "#3366cc"
