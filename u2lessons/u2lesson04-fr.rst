2.4 Leçon sur la résolution d'équations polynomiales
################################################################################
...
:summary: 2.4 Leçon sur la résolution d'équations polynomiales
...
.. image:: ../images/u2lesson04-gpimage06.png
   :scale: 50
   :alt: grille vierge, x de -6 à 6, y de -10 à 50
...
a\) Résolvez :math:`0 = 2x^3 + 3x^2 - 11x - 6`
...
Commencez par réarranger en ordre décroissant de degré :
...
.. image:: ../images/u2lesson04-gpimage07.png
   :scale: 50
   :alt: grille vierge, x de -2 à 4, y de -7 à 1
