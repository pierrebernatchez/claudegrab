2.6 Leçon sur la résolution d'inéquations
################################################################################
...
:summary: 2.6 Leçon sur la résolution d'inéquations
...
Remarque : Résoudre des ``________________`` linéaires est la même chose
que résoudre des ``______________`` linéaires. Cependant, lorsque les deux
côtés d'une inéquation sont multipliés ou divisés par un nombre
``______________``, le symbole d'inégalité doit être
...
.. image:: ../images/u2lesson06-gpimage10.png
   :scale: 50
   :alt: grille vierge, x de -8 à 8, y de -18 à 18
