...
# Shaded solution regions (-4 <= x <= -1, bounded, or x >= 2, unbounded),
# each an EXPLICIT closed polygon -- see u2lesson06-gpimage05.gp's
# comments for why (not gnuplot's automatic curve-to-axis fill).
set style fill transparent solid 0.3 noborder
set style arrow 1 head filled size screen 0.02,20 lw 3 lc rgb "#cc3333"
set arrow 1 from 2,0 to 8,0 as 1
