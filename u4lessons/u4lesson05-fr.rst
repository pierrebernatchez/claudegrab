5.3 Applications de la trigonométrie -- Leçon
################################################################################
...
:summary: 5.3 Applications de la trigonométrie -- Leçon
...
.. image:: ../images/u4lesson05-gpimage04.png
   :scale: 80
   :alt: grille vierge pour esquisser le déplacement vertical du passager en fonction du temps
...
.. image:: ../images/u4lesson05-gpimage05.png
   :scale: 80
...
.. list-table::
   ...
   * - **Remarque :** La distance horizontale entre les points de
       ...
       un cycle complet doit durer ``______`` heures.
