5.3 Transformations des fonctions trigonométriques -- Leçon
################################################################################
...
:summary: 5.3 Transformations des fonctions trigonométriques -- Leçon
...
.. image:: ../images/u4lesson03-gpimage10.png
   :scale: 80
   :alt: grille vierge avec graduations en fractions de pi pour esquisser la fonction transformée
...
.. image:: ../images/u4lesson03-gpimage04.png
   :scale: 80
   :alt: graphique de y = cos(x) sur l'intervalle de -2 pi à 2 pi
...
.. image:: ../images/u4lesson03-gpimage03.png
   :scale: 80
   :alt: graphique de y = sin(x) sur l'intervalle de -2 pi à 2 pi
