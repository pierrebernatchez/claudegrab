...
- :math:`a = -2`; réflexion verticale et étirement vertical par un facteur de 2 (:math:`-2y`)
- :math:`d = 1`; translation de 1 unité vers la droite (:math:`x + 1`)

b\) :math:`g(x) = \left[-\dfrac{1}{3}(x+5)\right]^4 - 1`

- :math:`k = -\dfrac{1}{3}`; réflexion horizontale et étirement horizontal par un facteur de 3 (:math:`-3x`)
- :math:`d = -5`; translation de 5 unités vers la gauche (:math:`x - 5`)
