5.1 Identités de cofonction -- Leçon avec solutions
################################################################################

:lang: fr
:date: 2026-09-24 20:58:38+00:00
:tags: douzième année, mathématiques, leçons, fiches d’exercices
:slug: u5lesson01-solutions
:category: mathématiques
:authors: Annie Bernatchez
:summary: 5.1 Identités de cofonction -- Leçon avec solutions
...
Des translations horizontales de :sol:`π/2` impliquant à la fois une
...
Rappelons que :math:`\cos x` est une fonction :sol:`paire`. Réfléchir
...
:sol:`impaires`. Elles ont une symétrie de rotation par rapport à
l'origine.
