### u3review09-gpimage08.gp
### Q3, thumbnail C: y = log_3(x). Shared identically between the
### blank and solutions documents (this is the question itself).

set terminal pngcairo size 220,220 enhanced font "Arial,9"
set output '../u3lessons-media/u3review09-gpimage08.png'
