...
- Une fonction polynomiale de degré :math:`n` a au plus
  ``____________`` points minimum/maximum (points tournants)
- Une fonction polynomiale de degré :math:`n` peut avoir jusqu'à ``____``
  zéros distincts (abscisses à l'origine)
- Si une fonction polynomiale est de degré ``________``, elle doit avoir
