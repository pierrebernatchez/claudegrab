### u5lesson06-gpimage05.gp
### Example 2: cos x = -1/2 (x = 2 theta substitution), two solutions
### x1 = 2pi/3 (Q2) and x2 = 4pi/3 (Q3), reference angle pi/3.

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5lesson06-gpimage05.png'
...
set label "{/Symbol p}/3" at -0.98,0.16 tc rgb "red" font ",9"
set label "{/Symbol p}/3" at -0.98,-0.16 tc rgb "blue" font ",9"
set label "2{/Symbol p}/3" at -0.75,0.55 tc rgb "red" font ",9"
set label "4{/Symbol p}/3" at -0.75,-0.55 tc rgb "blue" font ",9"
