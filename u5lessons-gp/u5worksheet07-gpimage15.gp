### u5worksheet07-gpimage15.gp
### Q9c: cos theta=-2/5, ref~1.16, Q2+Q3 -> 1.98,4.3

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet07-gpimage15.png'
...
set arrow from 0,0 to -0.3979,0.9174 lc rgb 'red' lw 2.2
set label "1.98" at -0.286,0.661 tc rgb "red" font ",9"
set arrow from 0,0 to -0.4008,-0.9162 lc rgb 'blue' lw 2.2
set label "4.3" at -0.289,-0.660 tc rgb "blue" font ",9"
