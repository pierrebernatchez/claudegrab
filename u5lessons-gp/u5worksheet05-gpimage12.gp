### u5worksheet05-gpimage12.gp
### Q3b: cos^2 x = 4/9, x=0.84,2.30,3.98,5.44

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet05-gpimage12.png'
...
set arrow from 0,0 to -0.6663,0.7457 lc rgb 'blue' lw 2.2
set label "2.30" at -0.480,0.537 tc rgb "blue" font ",9"
set arrow from 0,0 to -0.6686,-0.7436 lc rgb 'blue' lw 2.2
set label "3.98" at -0.481,-0.535 tc rgb "blue" font ",9"
set arrow from 0,0 to 0.6651,-0.7468 lc rgb 'red' lw 2.2
set label "5.44" at 0.479,-0.538 tc rgb "red" font ",9"
