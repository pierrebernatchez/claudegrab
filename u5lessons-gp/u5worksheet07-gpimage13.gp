### u5worksheet07-gpimage13.gp
### Q9b: sin theta=2/3, ref~0.73, Q1+Q2 -> 0.73,2.41

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet07-gpimage13.png'
...
set arrow from 0,0 to 0.7452,0.6669 lc rgb 'red' lw 2.2
set label "0.73" at 0.537,0.480 tc rgb "red" font ",9"
set arrow from 0,0 to -0.7441,0.6681 lc rgb 'blue' lw 2.2
set label "2.41" at -0.536,0.481 tc rgb "blue" font ",9"
