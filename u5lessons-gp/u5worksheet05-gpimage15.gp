### u5worksheet05-gpimage15.gp
### Q4a: sin^2 x = 1/4, x=pi/6,5pi/6,7pi/6,11pi/6

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet05-gpimage15.png'
...
set arrow from 0,0 to -0.8660,0.5000 lc rgb 'red' lw 2.2
set label "5{/Symbol p}/6" at -0.624,0.360 tc rgb "red" font ",9"
set arrow from 0,0 to -0.8660,-0.5000 lc rgb 'blue' lw 2.2
set label "7{/Symbol p}/6" at -0.624,-0.360 tc rgb "blue" font ",9"
set arrow from 0,0 to 0.8660,-0.5000 lc rgb 'blue' lw 2.2
set label "11{/Symbol p}/6" at 0.624,-0.360 tc rgb "blue" font ",9"
