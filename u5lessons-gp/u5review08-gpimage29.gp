### u5review08-gpimage29.gp
### Q17: sin x=0.625, Q1+Q2 -> 0.675,2.47

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5review08-gpimage29.png'
...
set arrow from 0,0 to 0.7807,0.6249 lc rgb 'red' lw 2.2
set label "0.675" at 0.562,0.450 tc rgb "red" font ",9"
set arrow from 0,0 to -0.7828,0.6222 lc rgb 'blue' lw 2.2
set label "2.47" at -0.564,0.448 tc rgb "blue" font ",9"
