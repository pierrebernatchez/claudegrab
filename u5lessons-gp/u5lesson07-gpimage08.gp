### u5lesson07-gpimage08.gp
### Ex2b: sin x = -0.23, ref ~0.23, Q3+Q4

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5lesson07-gpimage08.png'
...
set arrow from 0,0 to -0.9740,-0.2264 lc rgb 'red' lw 2.2
set label "3.37" at -0.701,-0.163 tc rgb "red" font ",9"
set arrow from 0,0 to 0.9729,-0.2311 lc rgb 'blue' lw 2.2
set label "6.05" at 0.701,-0.166 tc rgb "blue" font ",9"
