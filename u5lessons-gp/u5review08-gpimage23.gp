### u5review08-gpimage23.gp
### Q15c: cos x=1/3, Q1+Q4 -> 1.23,5.05

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5review08-gpimage23.png'
...
set arrow from 0,0 to 0.3342,0.9425 lc rgb 'red' lw 2.2
set label "1.23" at 0.241,0.679 tc rgb "red" font ",9"
set arrow from 0,0 to 0.3312,-0.9435 lc rgb 'blue' lw 2.2
set label "5.05" at 0.238,-0.679 tc rgb "blue" font ",9"
