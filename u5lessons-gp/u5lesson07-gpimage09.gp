### u5lesson07-gpimage09.gp
### Ex2b: sin x = 0.73, ref ~0.82, Q1+Q2

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5lesson07-gpimage09.png'
...
set arrow from 0,0 to 0.6822,0.7311 lc rgb 'red' lw 2.2
set label "0.82" at 0.491,0.526 tc rgb "red" font ",9"
set arrow from 0,0 to -0.6811,0.7322 lc rgb 'blue' lw 2.2
set label "2.32" at -0.490,0.527 tc rgb "blue" font ",9"
