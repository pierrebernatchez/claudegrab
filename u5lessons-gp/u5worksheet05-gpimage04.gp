### u5worksheet05-gpimage04.gp
### Q1d: sec x = 4, x1~1.32 (Q1), x2~4.96 (Q4)

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet05-gpimage04.png'
...
set arrow from 0,0 to 0.2482,0.9687 lc rgb 'red' lw 2.2
set label "1.32" at 0.179,0.697 tc rgb "red" font ",9"
set arrow from 0,0 to 0.2451,-0.9695 lc rgb 'blue' lw 2.2
set label "4.96" at 0.176,-0.698 tc rgb "blue" font ",9"
