### u5review08-gpimage14.gp
### Q13a: cos k=-1/4 (k=2x), Q2+Q3 -> 1.82,4.46

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5review08-gpimage14.png'
...
set arrow from 0,0 to -0.2466,0.9691 lc rgb 'red' lw 2.2
set label "1.82" at -0.178,0.698 tc rgb "red" font ",9"
set arrow from 0,0 to -0.2497,-0.9683 lc rgb 'blue' lw 2.2
set label "4.46" at -0.180,-0.697 tc rgb "blue" font ",9"
