### u5lesson06-gpimage03.gp
### Example 1: sin x = root3/2 (x = 2 theta substitution), two solutions
### x1 = pi/3 (Q1) and x2 = 2pi/3 (Q2), reference angle pi/3.

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5lesson06-gpimage03.png'
...
set label "{/Symbol p}/3" at 0.98,0.16 tc rgb "red" font ",9" right
set label "{/Symbol p}/3" at -0.98,0.16 tc rgb "blue" font ",9"
set label "{/Symbol p}/3" at 0.75,0.55 tc rgb "red" font ",9"
set label "2{/Symbol p}/3" at -0.75,0.55 tc rgb "blue" font ",9"
