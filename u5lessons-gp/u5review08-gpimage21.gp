### u5review08-gpimage21.gp
### Q15b: tan x=4, Q1+Q3 -> 1.33,4.47

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5review08-gpimage21.png'
...
set arrow from 0,0 to 0.2385,0.9711 lc rgb 'red' lw 2.2
set label "1.33" at 0.172,0.699 tc rgb "red" font ",9"
set arrow from 0,0 to -0.2400,-0.9708 lc rgb 'blue' lw 2.2
set label "4.47" at -0.173,-0.699 tc rgb "blue" font ",9"
