### u5worksheet05-gpimage06.gp
### Q1f: 2csc x + 5 = 0, x1~3.55 (Q3), x2~5.87 (Q4)

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet05-gpimage06.png'
...
set arrow from 0,0 to -0.9178,-0.3971 lc rgb 'red' lw 2.2
set label "3.55" at -0.661,-0.286 tc rgb "red" font ",9"
set arrow from 0,0 to 0.9158,-0.4015 lc rgb 'blue' lw 2.2
set label "5.87" at 0.659,-0.289 tc rgb "blue" font ",9"
