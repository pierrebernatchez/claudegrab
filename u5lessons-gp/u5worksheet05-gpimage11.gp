### u5worksheet05-gpimage11.gp
### Q3a: sin^2 x = 0.64, x=0.93,2.21,4.07,5.36

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet05-gpimage11.png'
...
set arrow from 0,0 to 0.6033,-0.7975 lc rgb 'blue' lw 2.2
set label "5.36" at 0.434,-0.574 tc rgb "blue" font ",9"
