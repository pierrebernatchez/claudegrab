### u5worksheet07-gpimage08.gp
### Q8: sin^2 x=1/2, ref pi/4, all quadrants

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet07-gpimage08.png'
...
set label "{/Symbol p}/4" at 0.509,0.509 tc rgb "red" font ",9"
set arrow from 0,0 to -0.7071,0.7071 lc rgb 'blue' lw 2.2
set label "3{/Symbol p}/4" at -0.509,0.509 tc rgb "blue" font ",9"
set arrow from 0,0 to -0.7071,-0.7071 lc rgb 'red' lw 2.2
set label "5{/Symbol p}/4" at -0.509,-0.509 tc rgb "red" font ",9"
set arrow from 0,0 to 0.7071,-0.7071 lc rgb 'blue' lw 2.2
set label "7{/Symbol p}/4" at 0.509,-0.509 tc rgb "blue" font ",9"
