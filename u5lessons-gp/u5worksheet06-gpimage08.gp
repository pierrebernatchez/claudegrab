### u5worksheet06-gpimage08.gp
### Qh: cos(theta)=-1/2, theta=2x, Q2:2pi/3, Q3:4pi/3

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet06-gpimage08.png'
...
set label "2{/Symbol p}/3" at -0.360,0.624 tc rgb "red" font ",9"
