### u5review08-gpimage20.gp
### Q15b: tan x=-7, Q2+Q4 -> 1.71,4.85

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5review08-gpimage20.png'
...
set arrow from 0,0 to -0.1388,0.9903 lc rgb 'red' lw 2.2
set label "1.71" at -0.100,0.713 tc rgb "red" font ",9"
set arrow from 0,0 to 0.1372,-0.9905 lc rgb 'blue' lw 2.2
set label "4.85" at 0.099,-0.713 tc rgb "blue" font ",9"
