### u5worksheet05-gpimage03.gp
### Q1c: tan x = 5, x1~1.37 (Q1), x2~4.51 (Q3)

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet05-gpimage03.png'
...
set arrow from 0,0 to 0.1994,0.9799 lc rgb 'red' lw 2.2
set label "1.37" at 0.144,0.706 tc rgb "red" font ",9"
set arrow from 0,0 to -0.2010,-0.9796 lc rgb 'blue' lw 2.2
set label "4.51" at -0.145,-0.705 tc rgb "blue" font ",9"
