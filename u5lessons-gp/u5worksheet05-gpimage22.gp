### u5worksheet05-gpimage22.gp
### Q5d: sin x = -1/2, x1=7pi/6 (Q3), x2=11pi/6 (Q4)

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet05-gpimage22.png'
...
set label "7{/Symbol p}/6" at -0.624,-0.360 tc rgb "red" font ",9"
