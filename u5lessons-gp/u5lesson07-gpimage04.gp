### u5lesson07-gpimage04.gp
### Example 1c: y=sin(x) over [0,2pi], marking the unique solution
### at x=pi/2 where sin x = 1.

set terminal pngcairo size 300,220 font ",10"
set output '../u5lessons-media/u5lesson07-gpimage04.png'
