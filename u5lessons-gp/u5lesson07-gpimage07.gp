### u5lesson07-gpimage07.gp
### Ex2a: tan x = 1/2, ref ~0.46, Q1+Q3

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5lesson07-gpimage07.png'
...
set arrow from 0,0 to 0.8961,0.4439 lc rgb 'red' lw 2.2
set label "0.46" at 0.645,0.320 tc rgb "red" font ",9"
set arrow from 0,0 to -0.8968,-0.4425 lc rgb 'blue' lw 2.2
set label "3.60" at -0.646,-0.319 tc rgb "blue" font ",9"
