### u5worksheet07-gpimage04.gp
### Q4: tan x=3, ref~1.25, Q1+Q3 -> 1.25,4.39

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet07-gpimage04.png'
...
set arrow from 0,0 to 0.3153,0.9490 lc rgb 'red' lw 2.2
set label "1.25" at 0.227,0.683 tc rgb "red" font ",9"
set arrow from 0,0 to -0.3168,-0.9485 lc rgb 'blue' lw 2.2
set label "4.39" at -0.228,-0.683 tc rgb "blue" font ",9"
