### u5review08-gpimage26.gp
### Q15e: sin x=-1/3, Q3+Q4 -> 3.48,5.94

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5review08-gpimage26.png'
...
set arrow from 0,0 to -0.9433,-0.3320 lc rgb 'red' lw 2.2
set label "3.48" at -0.679,-0.239 tc rgb "red" font ",9"
set arrow from 0,0 to 0.9417,-0.3365 lc rgb 'blue' lw 2.2
set label "5.94" at 0.678,-0.242 tc rgb "blue" font ",9"
