### u5worksheet07-gpimage05.gp
### Q4: tan x=-2, ref~1.107, Q2+Q4 -> 2.03,5.18

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet07-gpimage05.png'
...
set arrow from 0,0 to -0.4432,0.8964 lc rgb 'red' lw 2.2
set label "2.03" at -0.319,0.645 tc rgb "red" font ",9"
set arrow from 0,0 to 0.4508,-0.8926 lc rgb 'blue' lw 2.2
set label "5.18" at 0.325,-0.643 tc rgb "blue" font ",9"
