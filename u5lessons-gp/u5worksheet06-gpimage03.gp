### u5worksheet06-gpimage03.gp
### Qc: sin(theta)=0.75, theta=2x, theta1~0.85 (Q1), theta2~2.29 (Q2)

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet06-gpimage03.png'
...
set arrow from 0,0 to 0.6600,0.7513 lc rgb 'red' lw 2.2
set label "0.85" at 0.475,0.541 tc rgb "red" font ",9"
set arrow from 0,0 to -0.6588,0.7523 lc rgb 'blue' lw 2.2
set label "2.29" at -0.474,0.542 tc rgb "blue" font ",9"
