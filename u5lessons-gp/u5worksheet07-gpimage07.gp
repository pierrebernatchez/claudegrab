### u5worksheet07-gpimage07.gp
### Q7: tan x=-1/2, ref~0.46, Q2+Q4 -> 2.68,5.82

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet07-gpimage07.png'
...
set arrow from 0,0 to -0.8953,0.4454 lc rgb 'red' lw 2.2
set label "2.68" at -0.645,0.321 tc rgb "red" font ",9"
set arrow from 0,0 to 0.8946,-0.4468 lc rgb 'blue' lw 2.2
set label "5.82" at 0.644,-0.322 tc rgb "blue" font ",9"
