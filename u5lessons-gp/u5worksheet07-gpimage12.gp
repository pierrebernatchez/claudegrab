### u5worksheet07-gpimage12.gp
### Q9b: sin theta=-3/4, ref~0.85, Q3+Q4 -> 3.99,5.44

set terminal pngcairo size 380,380 enhanced font "Arial,11"
set output '../u5lessons-media/u5worksheet07-gpimage12.png'
...
set arrow from 0,0 to -0.6612,-0.7502 lc rgb 'red' lw 2.2
set label "3.99" at -0.476,-0.540 tc rgb "red" font ",9"
