# CAST-rule instance diagram: terminal arm at theta = 2{/Symbol p}/3,
# with its reference angle beta marked against the nearest x-axis.
set terminal pngcairo size 380,380 font ",13"
set output '../u4lessons-media/u4worksheet02-gpimage01.png'
...
set label "{/Symbol q}" at -0.660,1.223 tc rgb 'red' right
set label "{/Symbol b}={/Symbol p}/3" at -0.600,0.156 tc rgb "red"
