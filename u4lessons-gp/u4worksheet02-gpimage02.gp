# CAST-rule instance diagram: terminal arm at theta = {/Symbol p}/6,
# with its reference angle beta marked against the nearest x-axis.
set terminal pngcairo size 380,380 font ",13"
set output '../u4lessons-media/u4worksheet02-gpimage02.png'
...
set label "{/Symbol q}" at 1.143,0.740 tc rgb 'red' left
