...
set output '../u4lessons-media/u4review06-gpimage06.png'
...
set arrow from 0,0 to -0.000,-1.000 nohead dashtype 2 lc rgb 'red' lw 1.5
set label "3{/Symbol p}/2" at -0.000,-0.220 tc rgb 'red'
