...
set output '../u4lessons-media/u4lesson03-gpimage04.png'
...
do for [n=-12:12] {
    x = n*pi/6.0
    print sprintf("%f %f", x, cos(x))
}
set print
plot cos(x) with lines lc rgb 'red' lw 1.5, $DOTS using 1:2 with points pt 7 ps 0.9 lc rgb 'red'
