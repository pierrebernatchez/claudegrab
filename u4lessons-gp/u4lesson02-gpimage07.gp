# CAST-rule instance diagram: terminal arm at theta = 3{/Symbol p}/4,
# with its reference angle beta marked against the nearest x-axis.
set terminal pngcairo size 380,380 font ",13"
set output '../u4lessons-media/u4lesson02-gpimage07.png'
...
set label "{/Symbol q}" at -0.933,1.013 tc rgb 'red' right
