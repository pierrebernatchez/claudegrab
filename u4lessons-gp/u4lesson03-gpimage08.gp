...
set output '../u4lessons-media/u4lesson03-gpimage08.png'
...
k(x) = (abs(sin(x)) < 0.03) ? (1/0) : cos(x)/sin(x)
plot k(x) with lines dashtype 2 lc rgb '#d6567a' lw 1.5, \
     $DOTS using 1:2 with points pt 7 ps 0.9 lc rgb '#d6567a'
