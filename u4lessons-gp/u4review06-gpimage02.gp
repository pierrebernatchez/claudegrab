# CAST-rule instance diagram: terminal arm at theta = {/Symbol p}/3,
# with its reference angle beta marked against the nearest x-axis.
set terminal pngcairo size 380,380 font ",13"
set output '../u4lessons-media/u4review06-gpimage02.png'
...
set label "{/Symbol q}" at 0.660,1.223 tc rgb 'red' left
