# CAST-rule instance diagram: terminal arm at theta = 3{/Symbol p}/2,
# with its reference angle beta marked against the nearest x-axis.
set terminal pngcairo size 380,380 font ",13"
set output '../u4lessons-media/u4worksheet02-gpimage06.png'
...
set label "{/Symbol q}" at -0.000,-1.440 tc rgb 'red' left
