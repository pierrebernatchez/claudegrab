# CAST-rule instance diagram: terminal arm at theta = 11{/Symbol p}/6,
# with its reference angle beta marked against the nearest x-axis.
set terminal pngcairo size 380,380 font ",13"
set output '../u4lessons-media/u4worksheet02-gpimage07.png'
...
set label "{/Symbol q}" at 1.143,-0.780 tc rgb 'red' left
set label "{/Symbol b}={/Symbol p}/6" at 0.746,-0.090 tc rgb "red"
