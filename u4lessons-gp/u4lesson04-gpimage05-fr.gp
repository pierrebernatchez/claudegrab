...
set output '../u4lessons-media/u4lesson04-gpimage05-fr.png'
...
set label "distance" at 2.2,0.18 left font ",8" tc rgb 'dark-green'
set label "égale" at 2.2,-0.05 left font ",8" tc rgb 'dark-green'
