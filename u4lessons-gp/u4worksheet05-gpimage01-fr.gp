...
set output '../u4lessons-media/u4worksheet05-gpimage01-fr.png'
...
set label "1m" at -1.0,-1.35 right

set object circle at 0,-1 size 0.05 fc rgb 'red' fillstyle solid front
set label "départ\n0 ou 60" at 0,-1.55 center

set object circle at 1,0 size 0.05 fc rgb 'blue' fillstyle solid front
set label "15" at 1.2,0.1 left tc rgb 'blue'

set object circle at 0,1 size 0.05 fc rgb 'blue' fillstyle solid front
set label "30" at 0.15,1.2 left tc rgb 'blue'
set label "max: 21" at 0.15,1.45 left tc rgb 'blue'

set object circle at -1,0 size 0.05 fc rgb 'blue' fillstyle solid front
set label "45" at -1.2,0.1 right tc rgb 'blue'
